...
export default function MaintanenceHome() {
  return (
    <div className="w-3/4 flex flex-col items-center justify-center">
      <svg
        className="max-w-[350px]"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 490.831 203"
      >
        <g transform="translate(-60.546 -219)">
          <text
            transform="translate(112.377 260)"
            fill="#fff"
            fontSize="126"
          ...
          <text
            transform="translate(402.377 219)"
            fill="#cecece"
            fontSize="75"
            fontFamily="Roboto-Bold, Roboto"
            fontWeight="700"
          ...
          <path
            d="M40,161.947H17.472L14.28,54.039H43.2Zm-26.381,33.26a19.1,19.1,0,0,1,1.08-6.524,15.545,15.545,0,0,1,3.051-5.187,13.858,13.858,0,0,1,4.741-3.422,15.226,15.226,0,0,1,6.243-1.23,15.558,15.558,0,0,1,6.29,1.23,13.747,13.747,0,0,1,4.788,3.422,15.545,15.545,0,0,1,3.051,5.187,19.1,19.1,0,0,1,1.08,6.524,18.648,18.648,0,0,1-1.08,6.47,15.656,15.656,0,0,1-3.051,5.133,13.747,13.747,0,0,1-4.788,3.422,15.558,15.558,0,0,1-6.29,1.23,15.226,15.226,0,0,1-6.243-1.23,13.858,13.858,0,0,1-4.741-3.422,15.656,15.656,0,0,1-3.051-5.133A18.648,18.648,0,0,1,13.623,195.207Z"
            transform="matrix(0.998, -0.07, 0.07, 0.998, 43.187, 172.331)"
            fill="#5d5d5d"
          />
          <rect
            width="479"
            height="10"
            transform="translate(72 412)"
            fill="#4b4848"
          />
        </g>
      </svg>

      <code className="text-[#cecece] text-2xl my-6 mb-10 text-center max-[450px]:text-[1.3rem]">
        {"{ 200 Something's Cooking }"}
      </code>

      <ul className="w-full list-none p-0 m-0 flex justify-center flex-wrap">
        <li className="m-4 cursor-pointer min-w-[85px]">
          <a
            href="https://github.com/DivyanshBatham"
            target="_blank"
            rel="noopener noreferrer"
            className="no-underline fill-[#5d5d5d] text-[rgb(150,150,150)] flex flex-col items-center transition-all duration-200 ease-in-out hover:text-[#cecece] hover:fill-[#cecece] focus:text-[#cecece] focus:fill-[#cecece]"
          >
            <svg
              version="1.1"
              id="Capa_1"
              xmlns="http://www.w3.org/2000/svg"
              className="w-16 h-16 max-[450px]:w-12 max-[450px]:h-12"
              x="0px"
              y="0px"
            ...
            <span className="pt-3 text-[1.2rem] font-semibold">Github</span>
          </a>
        </li>

        <li className="m-4 cursor-pointer min-w-[85px]">
          <a
            href="https://linkedin.com/in/divyanshbatham/"
            target="_blank"
            rel="noopener noreferrer"
            className="no-underline fill-[#5d5d5d] text-[rgb(150,150,150)] flex flex-col items-center transition-all duration-200 ease-in-out hover:text-[#cecece] hover:fill-[#cecece] focus:text-[#cecece] focus:fill-[#cecece]"
          >
            ...
            <span className="pt-3 text-[1.2rem] font-semibold">Linkedin</span>
          </a>
        </li>

        <li className="m-4 cursor-pointer min-w-[85px]">
          <a
            href="https://codepen.io/NotNotCurious/"
            target="_blank"
            rel="noopener noreferrer"
            className="no-underline fill-[#5d5d5d] text-[rgb(150,150,150)] flex flex-col items-center transition-all duration-200 ease-in-out hover:text-[#cecece] hover:fill-[#cecece] focus:text-[#cecece] focus:fill-[#cecece]"
          >
